...
namespace TenantPM.Application.projects.Queries.GetProject
{
    public class ProjectDetailQueryHandler : IRequestHandler<ProjectDetailQuery,  ProjectDetailVn>
    {
        ...
        public ProjectDetailQueryHandler(IMapper mapper, IAsyncRepository<Project> projectRepository)
        {
            _mapper = mapper;
            _projectRepository = projectRepository;

        }
        public async Task<ProjectDetailVn> Handle(ProjectDetailQuery request, CancellationToken cancellationToken)
        {
